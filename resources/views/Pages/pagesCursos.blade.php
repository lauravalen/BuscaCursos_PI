                ...
                <div class="card_curso"
                    ...
                    <div class="info-curso">
                        ...
                        <a class="avaliacao"
                            ...
                            data-plataformas='@json($curso->plataformas->pluck("PLA_STR_NOME"))'>
                            Ver detalhes
                        </a>
    ...
    <div id="modalCurso" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-user-comentario">
                ...
                <form id="formAvaliacao" method="POST" action="{{ route('cursos.avaliar') }}">
                    @csrf
                    <input type="hidden" name="curso_id" id="cursoIdFeedback">
                    ...
                    <!-- Comentário -->
                    <textarea name="comentario" id="feedbackTexto"
